<template>
  <div style="width: 1000px;position: absolute;top: 80px;right: 15%;" align="center" >
        <el-row class="sharelistBox">
          <el-col :span="24" class="s-item tcommonBox" v-for="(item,index) in list.list" :key="'article'+index">
            <q-card style="margin-top: 10px;width: 800px;background-color: aliceblue" bordered>
