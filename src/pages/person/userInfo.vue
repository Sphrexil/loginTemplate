...
<!--      </div>-->
        ...
        <div class="PersonTop_text">
          <div class="user_text">
            <div style="margin-left: 150px;width: 100px">
              <div class="user_name">
                <span> {{ nickname }} </span>
              </div> <!--v-if="v === 3"-->
              <div class="user-v-font">
                <span>优质媒体作者</span>
              </div>
              <div class="user_qianming">
                <span> {{ design }} 我是你爹</span>
              </div>
              <div class="user_anniu" style="text-align: left">
                <el-button
                    class="el-icon-edit"
                    v-if="avatar !== null"
                    type="primary"
    ...
    <div class="person_body" >
      ...
      <info style="padding-top: 10px;width: 700px;"/>
...
import { mygoodCount } from "@/api/good.ts";
import PersonalDia from "./PersonalDia.vue";
import info from '@/pages/person/info.vue'

export default {
  components: { PersonalDia,brain:head, info,bcg},
  name: "Personal",
  inject: ["reload"],
  data() {
    return {
